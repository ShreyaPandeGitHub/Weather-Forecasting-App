...
def data_get():
    ...
    data = requests.get(
        "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=1ca597f644b425f4558dc9d3662982f1").json()
...
com = ttk.Combobox(win, text="Weather Forecasting  App", values=list_name, font=('Times New Roman', 20, "bold"),
